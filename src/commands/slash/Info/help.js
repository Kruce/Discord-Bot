        ...
        if (data) {
            ...
            switch (chosen.name) {
                case 'slash':
                    ...
                    embed.setTitle(`Slash command: \`${(command.type === 2 || command.type === 3) ? '' : '/'}${command.name}\``)
                    embed.addFields(
                ...
                case 'prefix':
                    ...
                    embed.setTitle(`Prefix command: \`${prefix}${command.structure.name}\``)
                    embed.addFields(
                ...
                case 'reaction':
                    ...
                    embed.setTitle(`Reaction command: <:${command.structure.name}:${command.structure.emojiId}>`)
                    embed.addFields(
                        { name: 'Description:', value: `${command.structure.description || '(No description)'}` }
                    );
                    break;
