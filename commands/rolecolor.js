...
module.exports = {
    ...
    usage: `*${process.env.COMMAND_PREFIX}rc red*, *${process.env.COMMAND_PREFIX}rc #ff0000*, *${process.env.COMMAND_PREFIX}rc ff0000*, *${process.env.COMMAND_PREFIX}rc rgb (255, 0, 0)*, *${process.env.COMMAND_PREFIX}rc rgb 255 0 0*, *${process.env.COMMAND_PREFIX}rc hsl(0, 100%, 50%)*, *${process.env.COMMAND_PREFIX}rc random*, *${process.env.COMMAND_PREFIX}rc default*`, //how to use the command
